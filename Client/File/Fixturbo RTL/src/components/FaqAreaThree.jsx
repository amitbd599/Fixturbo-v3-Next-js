          ...
          <div className="row justify-content-center">
            <div className="col-xl-5 col-lg-6 col-11">
              <div className="title-area text-center">
                <span className="sub-title">اشتركاشترك اشتر</span>
              ...
              <div className="accordion-area accordion" id="faqAccordion">
                  ...
                  >
                    <div className="accordion-body">
                      <p className="faq-text">
                        اشتركاشترك اشتر اشتركاشتاشتركاشترك اشتر
                        اشتركاشتاشتركاشترك اشتر اشتركاشتاشتركاشترك اشتر
                        اشتركاشتاشتركاشترك اشتر اشتركاشتاشتركاشترك اشتر
                        اشتركاشتاشتركاشترك اشتر اشتركاشتاشتركاشترك اشتر
                        اشتركاشتاشتركاشترك اشتر اشتركاشت
                      </p>
                    </div>
                  </div>
                </div>
                <div className="accordion-card style3">
                  <div className="accordion-header" id="collapse-item-2">
                    ...
                    >
                      {" "}
                      اشتر اشتركاشتاشتركاشترك شتركاشت
                    </button>
                  </div>
                  <div
                    id="collapse-2"
                ...
                <div className="accordion-card style3">
                  <div className="accordion-header" id="collapse-item-3">
                    ...
                    >
                      {" "}
                      اشتر كاشتاشتر كاشتركاش تركاشت اشترك اشترك
                    </button>
                  </div>
                  <div
                    id="collapse-3"
