                  ...
                  <div className="col-sm-6 col-lg-auto">
                    <div className="counter-card">
                      ...
                      <div className="media-body">
                        ...
                        <p className="counter-card_text">جائزة الفوز</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-sm-6 col-lg-auto">
                        ...
                        <h2 className="counter-card_number">
                          <TrackVisibility once>
                            {({ isVisible }) =>
                              isVisible && (
                                <span className="counter-number">
                                  +<CountUp delay={0} start={0} end={8} />k
                                </span>
                              )
                            }
                          </TrackVisibility>
                        </h2>
                        <p className="counter-card_text">عملاء سعداء</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-sm-6 col-lg-auto">
                        ...
                        <h2 className="counter-card_number">
                          <TrackVisibility once>
                            {({ isVisible }) =>
                              isVisible && (
                                <span className="counter-number">
                                  +<CountUp delay={0} start={0} end={9} />k
                                </span>
                              )
                            }
                          </TrackVisibility>
