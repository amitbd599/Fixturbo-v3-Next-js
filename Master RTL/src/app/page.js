          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 align-self-center">
              <div className="banner-inner text-center">
                ...
                />
                <h1 className="mt-4">
                  Fixturbo - قالب JS لتصليح السيارات وخدمات السيارات NEXT JS مع
                  RTL
                </h1>
                <p className="me-5 mb-5">
                  Fixturbo هو قالب NEXT Js لتصليح السيارات وخدمات السيارات،
                  والذي تم تصميمه لمجموعة من الخدمات مع وضع رقم الرابط الخاص
                  بمؤسسات خدمة السيارات وإصلاح السيارات في الاعتبار.
                </p>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/about"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/service"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/service-details"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/project"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/project-details"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/team"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/team-details"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/blog"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/blog-details"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/shop"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/shop-details"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="btn-group">
                  <Link
                    className="btn btn-base"
                    href="https://fixturbonext-rtl.wowtheme7.com/contact"
                  >
                    عرض حي
                  </Link>
                </div>
            ...
            <div className="col-lg-8">
              <div className="footer-widget widget text-center pd-bottom-100">
                ...
                <h5 className="text-white mb-5 mt-5 lh-base">
                  إهذا هو الرابط لنموذج NEXT لإصلاح السيارات وخدمات السيارات
                  الحديثة والجميلة. إنه موقع ويب خاص بشركة إصلاح السيارات وخدمات
                  السيارات.
                </h5>
                <a
                  className="btn btn-white"
