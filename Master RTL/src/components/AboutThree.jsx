          ...
          <div className="col-xl-5">
            <div className="about-content-wrap">
              <div className="title-area me-xl-5 mb-30">
                <span className="sub-title">اشترك في اشترك في</span>
                <h2 className="sec-title">لدينا للحصول لدينا</h2>
                <p className="sec-text">
                  لدينا للحصوللدينا للحصوللدينا للحصوللدينا للحصوللدينا
                  للحصوللدينا للحصوللدينا للحصوللدينا للحصوللدينا للحصوللدينا
                  للحصول
                </p>
              </div>
